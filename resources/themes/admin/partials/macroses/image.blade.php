<img
        ...
        src="{!! $image && !is_array($image) ? $image : 'http://www.placehold.it/' . $width . 'x' . $height . '/EFEFEF/AAAAAA&text=no+image' !!}"
        data-default="{!! 'http://www.placehold.it/' . $width . 'x' . $height . '/EFEFEF/AAAAAA&text=no+image' !!}"
/>

<div class="col-md-12 no-padding">
    <div class="input-group">
        {!! Form::text($name, $image && !is_array($image) ? $image : null, array_merge(['class' => 'form-control input-sm'], $params)) !!}
